...
class CommandInteraction extends Interaction {
  ...
  get command() {
    ...
    const guid = this.guild;
    let temp = ((guid === null || guid === undefined) ? undefined : guid.commands) || null;
    return temp.cache.get(id) || this.client.application.commands.cache.get(id) || null;
  }
  ...
  async fetchReply() {
    ...
    let temp = ((this.channel === null || this.channel === undefined) ? undefined : this.channel.messages) || null;
    return temp.add(raw) || raw;
  }
