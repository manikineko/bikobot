...
class VoiceConnection extends EventEmitter {
   ...
   */
  get voice() {
    let temp = this.channel.guild.me;
    return ((temp === null || temp === undefined) ? undefined : temp.voice) || null;
  }
    ...
    options = Util.mergeDefault(
      {
        ...
        self_mute: ((temp === null || temp === undefined) ? undefined : temp.selfMute) || false,
        self_deaf: ((temp === null || temp === undefined) ? undefined : temp.selfDeaf) || false,
      },
      options,
    );
